...
export function importTypeLabel(importType: string) {
  const labels: Record<string, string> = {
    ...
    keeta_drivers: "مناديب Keeta",
    keeta_accounts: "حسابات Keeta",
    hungerstation_drivers: "مناديب HungerStation",
    hungerstation_accounts: "حسابات HungerStation",
    hungerstation_invoice: "فاتورة HungerStation",
    hungerstation_performance: "أداء HungerStation",
    talabat_drivers: "مناديب Talabat",
    talabat_accounts: "حسابات Talabat",
