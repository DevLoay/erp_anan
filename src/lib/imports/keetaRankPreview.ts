...
const aliases: Record<keyof Omit<KeetaRankMappedRow, "rowNumber" | "rawData">, string[]> = {
  ...
  appUserId: ["courierid", "appuserid", "userid", "accountid", "keetaid", "appaccount", "رقمالحساب"],
  appUsername: ["appusername", "username", "accountusername", "account", "حسابالتطبيق"],
  rank: ["currentestimatedlevel", "current estimated level", "rank", "level", "keetarank", "الرانك", "المستوى"],
