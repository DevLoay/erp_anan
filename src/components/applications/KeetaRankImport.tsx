      ...
      {preview ? (
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button type="button" onClick={() => onToast("هذه الميزة قيد التطوير")} className="rounded-xl border border-slate-200 bg-white px-5 py-2 text-sm font-black text-slate-700">Go back and change column mapping</button>
          </div>
