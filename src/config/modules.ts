...
export const moduleSections: ModuleSection[] = [
    ...
    items: [
      {
        ...
        children: [
          ...
          { href: "/vehicle-cleaning", label: "نظافة السيارات", oldKey: "vehicleCleaning", status: connected, resource: "vehicle-cleaning", description: "تسجيل نظافة السيارة مع صورة إلزامية للسيارة." },
          ...
          { href: "/vehicle-accidents", label: "حوادث السيارات", oldKey: "vehicleAccidents", status: connected, resource: "vehicle-accidents", description: "تسجيل الحوادث مع مرفقات إثبات إلزامية." },
          { href: "/vehicle-damages", label: "تلفيات السيارات", oldKey: "vehicleDamages", status: connected, resource: "vehicle-damages", description: "تسجيل التلفيات مع مرفقات إثبات إلزامية." },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/invoices", label: "الفواتير العامة", oldKey: "invoices", status: migration, resource: "invoices", description: "الفواتير العامة. فواتير المشروع تدار من داخل Workspace المشروع." },
